...
$__System.registerDynamic("a0", ["27"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
`.split("\n").map((line) => line.trim()).filter((line) => line.length > 0).map((line) => line.split("|")[0]);
      UnitCompleteInput = class UnitCompleteInput extends React.Component {
        ...
        render() {
          ...
          return React.createElement("div", {className: "dropdown"}, React.createElement("input", __assign({}, this.props, {
            ref: "inp",
            autoCorrect: "off",
            autoComplete: "off",
            autoCapitalize: "none",
