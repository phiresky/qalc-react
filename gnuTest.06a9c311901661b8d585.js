...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CategorizeStore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var _units_2_12_definitions_units__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(40);
/* harmony import */ var _data_gnu_units_categorize_steps_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(41);
var _data_gnu_units_categorize_steps_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(41, 1);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(38);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var mobx_react__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(12);
/* harmony import */ var mobx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
function FullInfo({ store, box }) {
    const info = store.categoryTreeOf(box.start);
    return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", null,
        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("p", null, "Fully parsed info:"),
        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("pre", null,
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("p", null, info.comment),
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("b", null, "Category:"),
            " ",
            info.headings.map(x => `${x}`).join("\n -> "))));
}
function ContentTable({ x }) {
    const lines = x.split("\n").map(x => Object(_CategorizeStore__WEBPACK_IMPORTED_MODULE_0__[/* splitOnce */ "c"])(/\s/, x, true));
    return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("table", null,
        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("tbody", null, lines.map((l, i) => (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("tr", { key: i },
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("td", null, l[0]),
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("td", null, "="),
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("td", null, l[1])))))));
}
let RenderBox = class RenderBox extends react__WEBPACK_IMPORTED_MODULE_4__["Component"] {
    constructor() {
        super(...arguments);
        this.extended = false;
        this.toggle = () => (this.extended = !this.extended);
    }
    render() {
        const { store, box } = this.props;
        switch (box.type) {
            case _CategorizeStore__WEBPACK_IMPORTED_MODULE_0__[/* Type */ "a"].Deleted: {
                const text = store.getUncommentedText(box);
                if (text.length === 0)
                    return null;
                return react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("p", { className: "deleted-box" }, text);
            }
            case _CategorizeStore__WEBPACK_IMPORTED_MODULE_0__[/* Type */ "a"].Normal: {
                ...
                return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"](react__WEBPACK_IMPORTED_MODULE_4__["Fragment"], null,
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "well well-sm normal-box clickable", onClick: this.toggle },
                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "content" },
                            react__WEBPACK_IMPORTED_MODULE_4__["createElement"](ContentTable, { x: content })),
                        comment && (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "comment alert alert-info", style: { float: "left" } }, comment)),
                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { style: { clear: "both" } }),
                        this.extended && (react__WEBPACK_IMPORTED_MODULE_4__["createElement"](FullInfo, { store: store, box: box }))),
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("br", null)));
            }
            case _CategorizeStore__WEBPACK_IMPORTED_MODULE_0__[/* Type */ "a"].Heading: {
                const { headingsIndex, headingLevel } = store.categoryTreeOf(box.start);
                const H = ("h" + headingLevel);
                return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"](H, { className: "heading-box" },
                    headingsIndex.join("."),
                    ".",
                    " ",
...
], RenderBox.prototype, "extended", void 0);
RenderBox = __decorate([
    mobx_react__WEBPACK_IMPORTED_MODULE_6__["observer"]
], RenderBox);
class Tocs extends react__WEBPACK_IMPORTED_MODULE_4__["Component"] {
    render() {
        const { cats, store } = this.props;
        return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("ul", { className: "table-of-contents" }, cats.map((cat, i) => (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("li", { key: i },
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"](E, { store: store, ele: cat }))))));
    }
}
function E(p) {
    return p.ele.type === "category" ? (react__WEBPACK_IMPORTED_MODULE_4__["createElement"](Toc, { cat: p.ele.category, store: p.store })) : (react__WEBPACK_IMPORTED_MODULE_4__["createElement"](RenderBox, { box: p.ele.box, store: p.store }));
}
let Toc = class Toc extends react__WEBPACK_IMPORTED_MODULE_4__["Component"] {
    constructor() {
        super(...arguments);
        this.expanded = this.props.cat.path.length < 2;
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"](react__WEBPACK_IMPORTED_MODULE_4__["Fragment"], null,
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("p", { className: "toc-line" },
                expandable ? (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("span", { className: "clickable", onClick: this.toggle }, chr)) : (""),
                " ",
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("b", null,
                    cat.path.map(x => x + 1).join("."),
                    "."),
                " ",
                cat.name),
            this.expanded && react__WEBPACK_IMPORTED_MODULE_4__["createElement"](Tocs, { store: store, cats: cat.children })));
    }
};
__decorate([
    mobx__WEBPACK_IMPORTED_MODULE_7__["observable"]
], Toc.prototype, "expanded", void 0);
Toc = __decorate([
    mobx_react__WEBPACK_IMPORTED_MODULE_6__["observer"]
], Toc);
function All() {
    const store = new _CategorizeStore__WEBPACK_IMPORTED_MODULE_0__[/* default */ "b"](_units_2_12_definitions_units__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], _data_gnu_units_categorize_steps_json__WEBPACK_IMPORTED_MODULE_2__);
    const toc = store.getTableOfContents();
    console.log(toc);
    return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "gnu-rewrite-test container" },
        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("h1", null, "Contents"),
        react__WEBPACK_IMPORTED_MODULE_4__["createElement"](Tocs, { cats: toc, store: store })));
}
Object(react_dom__WEBPACK_IMPORTED_MODULE_3__["render"])(react__WEBPACK_IMPORTED_MODULE_4__["createElement"](All, null), document.getElementById("app"));
...
/******/ });
//# sourceMappingURL=gnuTest.06a9c311901661b8d585.js.map