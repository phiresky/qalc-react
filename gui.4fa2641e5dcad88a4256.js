...
/******/ 			return "" + chunkId + "." + {"141":"6b3b29167081671d2057","351":"170c306aa40f7270a28c"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			// return url for filenames based on template
/******/ 			return "" + (chunkId === 929 ? "gui" : chunkId) + "." + {"141":"31d6cfe0d16ae931b73c","351":"31d6cfe0d16ae931b73c"}[chunkId] + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "qalc-react:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkqalc_react"] = self["webpackChunkqalc_react"] || [];
...
;// CONCATENATED MODULE: ./src/unitNumber/output.ts
class TaggedString {
    constructor(...vals) {
 ...
 */
class DimensionMap extends Map {
    ...
    toMismatchString() {
        ...
        return `have ${new DimensionMap(tooMuch).toString()}, want ${new DimensionMap(notEnough).toString()}`;
    }
}
Object.defineProperty(DimensionMap, "unicodePow", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: "⁰¹²³⁴⁵⁶⁷⁸⁹"
...
Object.defineProperty(Dimension, "dimensions", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: new Map()
...
class UnitNumber {
    constructor(value, dimensions = new DimensionMap(), id) {
        ...
        if (value !== null)
            this.value = new (decimal_default())(value);
        if (dimensions !== null)
    ...
    mul(other) {
        ...
        return new UnitNumber(this.value.times(other.value), DimensionMap.join({ dimensions: this.dimensions, factor: 1 }, { dimensions: other.dimensions, factor: 1 }), null);
    }
    div(other) {
        if (other.isSpecial())
        ...
        return new UnitNumber(this.value.div(other.value), DimensionMap.join({ dimensions: this.dimensions, factor: 1 }, { dimensions: other.dimensions, factor: -1 }), name);
    }
    plus(other, factor = 1) {
        if (other.isSpecial())
    ...
    pow(factor) {
        if (typeof factor === "number" || factor instanceof (decimal_default()))
...
Object.defineProperty(UnitNumber, "zero", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: new UnitNumber(0)
});
Object.defineProperty(UnitNumber, "one", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: new UnitNumber(1)
});
Object.defineProperty(UnitNumber, "minusOne", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: new UnitNumber(-1)
 ...
 */
class SpecialUnitNumber extends UnitNumber {
    constructor(meta) {
        ...
        Object.defineProperty(this, "fnTree", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
;// CONCATENATED MODULE: ./src/libqalc/RPNTokenType.ts
const Identifier2 = "Identifier";
const RPNTokenType_Number = "Number";
const LParen = "LParen";
const RParen = "RParen";
...
;// CONCATENATED MODULE: ./src/libqalc/TokenType.ts
const Identifier = "Identifier";
const TokenType_Number = "Number";
const TokenType_LParen = "LParen";
const TokenType_RParen = "RParen";
const Operator = "Operator";
const TokenType_Whitespace = "Whitespace";
const TokenType_Unknown = "Unknown";

;// CONCATENATED MODULE: ./src/libqalc/parser.ts



const TokenTypeRegex = [
    [/^\s+/, TokenType_Whitespace],
    [/^\(/, TokenType_LParen],
    [/^\)/, TokenType_RParen],
    [/^(=>|<=|>=|\|\||&&|==|!=|[ =≈+*/^|·!<>-]|to )/, Operator],
    [
...
function* preprocess(tokens) {
    ...
    for (const token of tokens) {
        ...
        if (lastToken)
            yield lastToken;
        if (lastToken &&
            [Identifier, TokenType_Number, TokenType_LParen].indexOf(token.type) >= 0 &&
            [Identifier, TokenType_Number, TokenType_RParen].indexOf(lastToken.type) >= 0)
            yield { type: Operator, str: "", start: token.start };
        if (token.type === Operator) {
            ...
            if (token.str === "in")
                token.str = "to";
            if (!lastToken ||
                [TokenType_LParen, Operator].indexOf(lastToken.type) >= 0) {
...
function* toRPN(tokens) {
    ...
    function yieldOperator(token) {
        ...
        if (infix_mode === "infix")
            return Object.assign(Object.assign({}, token), { type: InfixOperator });
        else
            return Object.assign(Object.assign({}, token), { type: UnaryOperator });
    }
    for (const token of tokens) {
        switch (token.type) {
            ...
            case TokenType_RParen: {
                while (top(stack) && top(stack).type !== TokenType_LParen)
                    yield stack.pop();
                if (stack.length === 0)
    ...
    while (stack.length > 0) {
        if (top(stack).type === UnaryOperator)
            yield stack.pop();
        else if (top(stack).type === InfixOperator) {
            yield stack.pop();
...
;// CONCATENATED MODULE: ./src/libqalc/Tree.ts
...
class FunctionCallNode {
    constructor(fnname, operands) {
        ...
        Object.defineProperty(this, "operands", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: operands
...
const operators_unaryOperators = {
...
const operators_infixOperators = {
    "=": assignment,
    "≈": assignment,
    ...
    "=>": makeRawFn(false, (node, scope) => {
        ...
        if (argNameNode instanceof IdentifierNode) {
            const argName = argNameNode.identifier;
            return new SpecialUnitNumber({
                fnTree: val,
                fn: (arg) => {
                    const argval = new IdentifierNode(argName);
                    argval.value = arg;
    ...
    "==": makeFn((a, b) => a.value.equals(b.value) && a.dimensions.equals(b.dimensions) ? yes : no),
    "!=": makeFn((a, b) => (a.dimensions.assertEqual(b.dimensions),
...
;// CONCATENATED MODULE: ./src/libqalc/functions.ts
...
const internalFunctions = [
    ...
    },
    {
        ...
        fn: (num) => {
            ...
            return libqalc_globalScope.deleteUnit(num.id) ? UnitNumber.one : UnitNumber.zero;
        },
        hasSideEffects: true,
    },
    {
        name: "log2",
        fn: (num) => (num.dimensions.assertEmpty(), new UnitNumber(num.value.logarithm(2))),
    },
    {
        name: "exp",
        fn: (num) => (num.dimensions.assertEmpty(), new UnitNumber(num.value.exp())),
    },
    {
        name: "tan",
...
;// CONCATENATED MODULE: ./src/libqalc/load.ts
...
function loadUnit(scope, data, postEvaluate) {
    ...
    if (tree instanceof FunctionCallNode && tree.fnname === "=") {
        const nameNode = tree.operands[0];
        const name = nameNode instanceof IdentifierNode && nameNode.identifier;
        if (!name) {
    ...
    else if (tree instanceof FunctionCallNode && tree.fnname === "!") {
...
;// CONCATENATED MODULE: ./src/libqalc/init.ts
...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof window === "undefined") {
            ...
            console.log("webpack");
            // running in webpack
            gnuUnitsData = yield __webpack_require__.e(/* import() */ 141).then(__webpack_require__.t.bind(__webpack_require__, 141, 19));
            customData = (yield __webpack_require__.e(/* import() */ 351).then(__webpack_require__.bind(__webpack_require__, 351)))
                .default;
        }
        libqalc_globalScope.addFunctions(...internalFunctions);
        loadUnitsJson(libqalc_globalScope, "units.json", gnuUnitsData);
        loadUnitsTxt(libqalc_globalScope, "custom_data.txt", customData, true);
    });
}
...
function parseEvaluate(str) {
    return evaluate(parse(stripCommentsTrim(str).code), libqalc_globalScope);
}
...
function resolveFunction(node, _scope) {
    if (node instanceof InfixFunctionCallNode) {
        const op = node.fnname;
        const fn = operators_infixOperators[op];
        if (!fn)
            throw Error("function not found: " + op);
        return fn;
    }
    else if (node instanceof UnaryFunctionCallNode) {
        const op = node.fnname;
        const fn = operators_unaryOperators[op];
        if (!fn)
            throw Error("function not found: " + op);
        return fn;
    }
...
function evaluate(node, scope) {
    ...
    else if (node instanceof InfixFunctionCallNode) {
        const fn = resolveFunction(node, scope);
...
function define(unit, scope) {
    if (unit instanceof IdentifierNode)
    ...
    const aliasesText = aliases && aliases.length > 0
        ? TaggedString.t `Aliases: ${TaggedString.join(aliases.map((a) => a.value), ", ")}`
        : "";
...
class Scope {
    constructor(scopes) {
        Object.defineProperty(this, "globalScope", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "canonicalMap", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
    ...
    addFunctions(...fns) {
        for (const { name, fn, hasSideEffects = false, mode = "leftOnly", } of fns) {
            const builtin = new IdentifierNode("[builtin]");
            builtin.value = new SpecialUnitNumber({
                fnTree: new NumberNode("[built in]"),
                fn: function apply(a, modeB) {
            ...
            evaluate(new InfixFunctionCallNode("=", [
                ...
                for (const prefix of this.prefixMap.keys()) {
                    if (name.startsWith(prefix)) {
                        ...
                        if (prefix.length < name.length) {
                            ...
                            if (suffix === null)
                                continue;
                            const unitValue = evaluate(new InfixFunctionCallNode("·", [
                                unit,
                                suffix,
                            ]), this);
                            if (unitValue.value.isSpecial())
                                continue; // ignore suffix on functions
                            unit = new InfixFunctionCallNode("=", [
                                new IdentifierNode(name),
                                unitValue,
                            ]);
...
/* harmony default export */ const libqalc_globalScope = (globalScope);

;// CONCATENATED MODULE: ./src/libqalc/index.ts
var libqalc_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
function unitConvertedTaggedString(node, scope) {
    if (node instanceof FunctionCallNode && node.fnname === "to") {
        const unit = evaluate(node.operands[1], scope);
        const numericValue = evaluate(node.operands[0], scope).value.div(unit.value);
        return TaggedString.t `${numericValue.toString()} ${unit.toTaggedString()}`;
    }
    else
        return evaluate(node, scope).value.toTaggedString();
}
function isDefinition(node) {
    if (node.value.id && node instanceof IdentifierNode)
        return true;
}
function qalculationHasSideeffect(input) {
    return libqalc_awaiter(this, void 0, void 0, function* () {
        try {
            const tree = rpnToTree(toRPN(preprocess(tokenize(input))));
            return evaluationHasSideeffect(tree, libqalc_globalScope);
        }
        catch (e) {
...
function qalculate(_input, debug = false) {
    return libqalc_awaiter(this, void 0, void 0, function* () {
        const scope = libqalc_globalScope;
        if (debug)
            return qalculateDebug(_input);
        const { code, comment } = stripCommentsTrim(_input);
        const inputTree = rpnToTree(toRPN(preprocess(tokenize(code))));
...
res = ${evaled
            ? TaggedString.t `${evaled.toTaggedString()} = ${unitConvertedTaggedString(evaled, scope)}`
            : "err"}
tokens = ${tokens
            ? tokens.map((t) => tokenToDebugString(t)).join(" ")
            : "err"}
preproc = ${preproc
            ? preproc.map((t) => tokenToDebugString(t)).join(" ")
            : "err"}
rpn = ${rpn ? rpn.map((t) => tokenToDebugString(t)).join(" ") : "err"}
...
function createDecorator(type) {
  return mobx_esm_assign(function (target, property) {
...
computed.struct = /*#__PURE__*/mobx_esm_assign(function (target, property) {
...
var CACHED_ANNOTATIONS = /*#__PURE__*/(/* unused pure expression or super */ null && (Symbol("mobx-cached-annotations")));
...
Object.defineProperty(GuiLineElement, "idCounter", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: 0
...
class GuiState {
    constructor() {
        ...
        Object.defineProperty(this, "currentInput", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: ""
        });
        Object.defineProperty(this, "currentOutput", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new TaggedString()
        });
        makeObservable(this, {
            lines: observable,
    ...
    setInput(input) {
        return gui_store_awaiter(this, void 0, void 0, function* () {
            ...
            if (yield qalculationHasSideeffect(input)) {
                ...
                const res = yield this.calcToString(input);
                runInAction(() => {
...
class UnitCompleter {
    constructor(target) {
        ...
        Object.defineProperty(this, "cursorIndexChars", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "replaceCurrent", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (u) => {
    ...
    get tokens() {
        ...
        const cursorIndex = tokens.findIndex((t) => t.type !== TokenType_Whitespace &&
    ...
    getPossibleUnits() {
        ...
        if (cursorToken) {
            if (cursorIndex === tokens.length - 1 &&
                cursorToken.str === "to ") {
                try {
                    const evaled = parseEvaluate(tokens
                        .slice(0, cursorIndex)
                        .map((x) => x.str)
                        .join(""));
                    const val = evaled.value;
                    for (const name of libqalc_globalScope.getAllUnits()) {
                        const unit = libqalc_globalScope.getUnit(name).value;
                        if (!unit.isSpecial() &&
            ...
            if (cursorToken.type === Identifier) {
                const units = poss.length > 0 ? poss.splice(0) : libqalc_globalScope.getAllUnits();
...
function Mask(props) {
  ...
  return react.createElement(es, Object.assign({}, motion, {
    visible: visible,
    removeOnLeave: true
  }), function (_ref) {
  ...
  var Trigger = /*#__PURE__*/function (_React$Component) {
    ...
    function Trigger(props) {
      ...
      _this.getRootDomNode = function () {
        ...
        return react_dom.findDOMNode(assertThisInitialized_assertThisInitialized(_this));
      };
...
;// CONCATENATED MODULE: ./src/ui/components/DefinitionOverlay.tsx
...
var DefinitionOverlay_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
let DefinitionOverlay = class DefinitionOverlay extends react.Component {
    constructor(p) {
        super(p);
    ...
    load() {
        return DefinitionOverlay_awaiter(this, void 0, void 0, function* () {
            try {
                this.setDefinition((yield qalculate(this.props.unit.id)).output);
            }
            catch (e) {
    ...
    render() {
        if (this.definition)
            return (react.createElement(TaggedStringDisplay, { text: this.definition, ignore: [this.props.unit], onClickUnit: this.props.onClickUnit }));
        return react.createElement("div", null, "Loading");
    }
};
__decorate([
    action
], DefinitionOverlay.prototype, "setDefinition", null);
DefinitionOverlay = __decorate([
    mobxreact_esm_observer
], DefinitionOverlay);


;// CONCATENATED MODULE: ./src/ui/components/TaggedStringDisplay.tsx
...
class TaggedStringDisplay extends react.Component {
    ...
    taggedStringToHtml(str) {
        return str.vals.map((x, i) => {
            if (typeof x === "string")
                ...
                return (react.createElement(rc_tooltip_es, { key: i, placement: "bottom", overlay: () => (react.createElement(DefinitionOverlay, { unit: x, onClickUnit: this.props.onClickUnit })) },
    ...
    render() {
        return (react.createElement("div", { className: `tagged-string-display ${this.props.className || ""}` }, this.taggedStringToHtml(this.props.text)));
    }
}

;// CONCATENATED MODULE: ./src/ui/components/GUILine.tsx
    ...
    render() {
        ...
        return (react.createElement("div", { className: "gui-line" },
            ...
            !isDefinition && (react.createElement("div", { style: { cursor: "pointer" }, onClick: () => this.props.onClickInput(this.props.line) },
                react.createElement(TaggedStringDisplay, { text: input, onClickUnit: this.props.onClickUnit }))),
            react.createElement(TaggedStringDisplay, { className: "block-response", text: isDefinition ? output : TaggedString.t ` = ${output}`, onClickUnit: this.props.onClickUnit }),
            react.createElement("hr", null)));
    }
}

;// CONCATENATED MODULE: ./src/ui/components/UnitCompleteInput.tsx
var UnitCompleteInput_decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
let UnitCompleteInput = class UnitCompleteInput extends react.Component {
    constructor(props) {
        super(props);
        ...
        Object.defineProperty(this, "inpRef", {
            enumerable: true,
            configurable: true,
            writable: true,
...
UnitCompleteInput = UnitCompleteInput_decorate([
    mobxreact_esm_observer
], UnitCompleteInput);


;// CONCATENATED MODULE: ./src/ui/components/GUI.tsx
...
function loadPresetLines() {
    return GUI_awaiter(this, void 0, void 0, function* () {
        ...
        if (state) {
            const str = lz_string.decompressFromEncodedURIComponent(state);
            if (str) {
                const ser = JSON.parse(str);
                presets = ser.lines;
            }
        }
        const savedHistory = localStorage.getItem("qalc-history");
        if (savedHistory) {
            const str = lz_string.decompressFromUTF16(savedHistory);
            if (str) {
                const ser = JSON.parse(str);
                presets = ser.lines;
            }
        }
        yield guiInst.guist.loadPresets(presets);
    });
}
let GUI = class GUI extends react.Component {
    constructor(props) {
        super(props);
        Object.defineProperty(this, "guist", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new GuiState()
        });
        Object.defineProperty(this, "completer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new UnitCompleter(this.guist)
        });
        ...
        return (react.createElement("div", { className: "container calc-ui" },
            ...
            react.createElement("div", { className: "gui-line unit-complete" },
                react.createElement("form", { onSubmit: this.onSubmit },
                    react.createElement(UnitCompleteInput, { completer: this.completer }),
                    this.guist.currentOutput.vals.length > 0 ? (react.createElement(TaggedStringDisplay, { className: "inline-response", text: TaggedString.t ` = ${this.guist.currentOutput}`, onClickUnit: (unit) => this.showUnit(unit) })) : ("")),
                react.createElement("hr", null)),
            this.guist.lines.map((line, i) => (react.createElement(GUILine, { key: line.id, index: i, line: line, onClickInput: () => this.guist.setInput(line.data.input.toString()), onClickUnit: (unit) => this.showUnit(unit), onClickRemove: () => this.guist.removeLine(i) }))),
