...
let HelperGui = class HelperGui extends react.Component {
    constructor(props) {
        ...
        autorun(() => this.checkConsistency(), {
            name: "consistency check",
        });
        reaction(() => JSON.stringify(this.store.executed), (data) => {
...
function init(str, preloadSteps) {
    ...
    react_dom.render(react.createElement("div", null,
        react.createElement(HelperGui, { store: new CategorizeStore(str, actions), ref: (guiInst) => Object.assign(window, { guiInst }) })), getAppDiv());
}
...
/******/ })()
;
//# sourceMappingURL=GnuUnitsCategorizeHelper.9b7f67953cec6e23cead.js.map