...
;// CONCATENATED MODULE: ./src/units-importer/rewrite-gnu-units.tsx
...
function FullInfo({ store, box }) {
    ...
    return (react.createElement("div", null,
        react.createElement("p", null, "Fully parsed info:"),
        react.createElement("pre", null,
            react.createElement("p", null, info.comment),
...
function ContentTable({ x }) {
    ...
    return (react.createElement("table", null,
        react.createElement("tbody", null, lines.map((l, i) => (react.createElement("tr", { key: i },
            react.createElement("td", null, l[0]),
            react.createElement("td", null, "="),
            react.createElement("td", null, l[1])))))));
}
const RenderBox = mobxreact_esm_observer(class RenderBox extends react.Component {
    constructor(props) {
        super(props);
        ...
        Object.defineProperty(this, "toggle", {
            ...
            configurable: true,
            writable: true,
            value: () => (this.extended = !this.extended)
        });
        makeObservable(this, {
            extended: observable,
        });
    ...
    render() {
        ...
        switch (box.type) {
            case Type.Deleted: {
                ...
                if (text.length === 0)
                    return null;
                return react.createElement("p", { className: "deleted-box" }, text);
            }
            case Type.Normal: {
                const { content, comment } = store.getBoxContent(box);
                return (react.createElement(react.Fragment, null,
                    react.createElement("div", { className: "well well-sm normal-box clickable", onClick: this.toggle },
                        react.createElement("div", { className: "content" },
                            react.createElement(ContentTable, { x: content })),
                        comment && (react.createElement("div", { className: "comment alert alert-info", style: { float: "left" } }, comment)),
                        react.createElement("div", { style: { clear: "both" } }),
                        this.extended && (react.createElement(FullInfo, { store: store, box: box }))),
                    react.createElement("br", null)));
            }
            case Type.Heading: {
                const { headingsIndex, headingLevel, } = store.categoryTreeOf(box.start);
                const H = ("h" + headingLevel);
                return (react.createElement(H, { className: "heading-box" },
                    headingsIndex.join("."),
                    ".",
                    " ",
...
class Tocs extends react.Component {
    render() {
        ...
        return (react.createElement("ul", { className: "table-of-contents" }, cats.map((cat, i) => (react.createElement("li", { key: i },
            react.createElement(E, { store: store, ele: cat }))))));
    }
}
function E(p) {
    return p.ele.type === "category" ? (react.createElement(Toc, { cat: p.ele.category, store: p.store })) : (react.createElement(RenderBox, { box: p.ele.box, store: p.store }));
}
const Toc = mobxreact_esm_observer(class Toc extends react.Component {
    constructor(props) {
        super(props);
        Object.defineProperty(this, "expanded", {
            ...
            configurable: true,
            writable: true,
            value: this.props.cat.path.length < 2
        });
        Object.defineProperty(this, "toggle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: () => (this.expanded = !this.expanded)
        });
        makeObservable(this, {
            expanded: observable,
        });
    ...
    render() {
        ...
        return (react.createElement(react.Fragment, null,
            react.createElement("p", { className: "toc-line" },
                expandable ? (react.createElement("span", { className: "clickable", onClick: this.toggle }, chr)) : (""),
                " ",
                ...
                " ",
                cat.name),
            this.expanded && (react.createElement(Tocs, { store: store, cats: cat.children }))));
    }
});
function All() {
    const store = new CategorizeStore(definitions_units, gnu_units_categorize_steps_namespaceObject);
    const toc = store.getTableOfContents();
    console.log(toc);
    return (react.createElement("div", { className: "gnu-rewrite-test container" },
        react.createElement("h1", null, "Contents"),
        react.createElement(Tocs, { cats: toc, store: store })));
}
(0,react_dom.render)(react.createElement(All, null), document.getElementById("app"));

})();

/******/ })()
;
//# sourceMappingURL=gnuTest.982092902188726491c4.js.map